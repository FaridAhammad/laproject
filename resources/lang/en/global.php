...
return [
    ...
    'yourAccountNeedsAdminApproval'        => 'Your accounts needs an product_management approval in order to log in',
    'timeFrom'                             => 'From',
    'timeTo'                               => 'To',
    ...
    /* ProductManages Start
    --------------------------------------------- */

    'productManages' => [
        'title'          => 'Product Manages',
    ...
    'vendorManages'      => [
        'title'          => 'Vendor Manages',
        'title_singular' => 'Vendor Manages',
        'fields'         => [
            'id'                 => 'ID',
            'id_helper'          => '',
            'title'              => 'Title',
    ...
    'vendorPurchase'      => [
        ...
        'title_singular' => 'Vendor Purchase',
        'fields'         => [
            'id'                 => 'ID',
            'id_helper'          => '',
            'title'              => 'Title',
    ...
    'otherSales'      => [
        'title'          => 'Other Sales/Issue',
        'title_singular' => 'Other Sales/Issue',
        'fields'         => [
            'id'                 => 'ID',
            'id_helper'          => '',
            'title'              => 'Title',
    ...
    'purchaseReports'      => [
        ...
        'title_singular' => 'Purchase Reports',
        'fields'         => [
            'id'                 => 'ID',
            'id_helper'          => '',
            'title'              => 'Title',
    ...
    'not_approved_p'                       => 'Your account is still not approved by product_management. Please, be patient and try again later.',
