        ...
        <ul class="nav">
            ...
            <li class="nav-item nav-dropdown">
                ...
                <ul class="nav-dropdown-items">
                    ...
                    <li class="nav-item">
                        <a href="{{ route("admin.productmanage.index") }}" class="nav-link {{ request()->is('admin/productmanage') || request()->is('admin/productmanage/*') ? 'active' : '' }}">
                            <i class="fa fa-briefcase nav-icon">
                    ...
                    <li class="nav-item">
                    /* Added By Mohiuddin */
                    <a href="{{ route("admin.unitmanage.index") }}" class="nav-link {{ request()->is('admin/unitmanage') || request()->is('admin/unitmanage/*') ? 'active' : '' }}">
                    /* ------------------ */
                    <i class="fa fa-user nav-icon">
